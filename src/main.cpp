...
const std::string MODEL_PATH = "resources/model/viking_room.obj";
const std::string TEXTURE_PATH = "resources/texture/viking_room.png";
...
private:
	...
	void loadModel() {
		...
		auto transform = glm::translate(glm::mat4(1.0f), glm::vec3(0))
		...
		for (const auto& shape : shapes) {
			for (const auto& index : shape.mesh.indices) {
				...
				vertex.pos = transform * glm::vec4(vertex.pos, 1.0f);
